      ...
      {INSTRUMENTS.map((inst) => {
        ...
        return (
          <button
            ...
            className={`flex flex-col items-center gap-1.5 rounded-xl border p-3 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-500/50
              ${active
          ...
          >
            ...
            <span className={`text-xs font-medium text-center leading-tight ${active ? 'text-cyan-300' : 'text-slate-400'}`}>
              {inst.label}
            </span>
            {active && (
